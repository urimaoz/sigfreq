function [tstat] = GetTStat2(x,y,varargin)
% function [tstat] = GetTStat2(x,y,varargin)
% 
% This is a special version of 'ttest2' that is quicker in getting back
% only the t statistic (usually a part of the 'stats' output variable).
%GETTSTAT2 Two-sample t-test with pooled or unpooled variance estimate.
%   T = GETTSTAT2(X,Y) performs a t-test of the hypothesis that two
...
%   test, use the GETTSTAT function.
%
%   X and Y can also be matrices or N-D arrays.  For matrices, GETTSTAT2
...
%   arrays, GETTSTAT2 works along the first non-singleton dimension.  X and
%   Y must have the same size along all the remaining dimensions.
%
%   GETTSTAT2 treats NaNs as missing values, and ignores them.
%
%
%   [...] = GETTSTAT2(X,Y,'PARAM1',val1,'PARAM2',val2,...) specifies one or
...
%
%   See also GETTSTAT2, TTEST2, TTEST, RANKSUM, VARTEST2, ANSARIBRADLEY.
