...
p.sSmoothingMethod = 'loess'; % The method of smoothing. See smooth() funciton in Cruve Fitting Toolbox for other potential methods. Note that robust methods may eliminate narrow spectrum peaks
p.nSmoothingSpan = 0.1; % Smoothing span for the spectrum. If < 1 signifies ratio of data to use, if >1 signifies #samples to use. 0 for no smoothing
